...
//        System.out.println(PokemonStruct.pokeDex.get("Purin"));
        ...
        //PokemonStruct 클래스에 있는 pokeEvolveDex에서 purin을 호출해서 그에 대한 value값을 evolvedFormName에 저장함.
        //저장한 value값을 pokemonstruct의 pokedex에서 value값에 대한 정보를 evolvedInfoObj에 저장하고 그 값을 출력
        //출력값:EvolvedPokemonStruct{PokemonStruct{monsterName='Purin', nickName='', hp=200, maxHp=200, skill1Name='노래부르기', skill1Dmg=0}, skill2Name='낙서', skill2Dmg=100}
